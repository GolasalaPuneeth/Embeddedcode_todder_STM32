  ...
  delay(2000);
   ...
   if(num==ran&&key != NO_KEY){  
    ...
    break;
     ...
     if(count==3&&key!=NO_KEY){ //completed
      count=0;
    ...
    if(num==90&&key!=NO_KEY){ //completed
      count=0;
      flag=0;
      Serial.println("inner loop breaked.");
      break;
      }
    if(num==87 && key!=NO_KEY){ //completed
      count=0;
      flag=0;
      Serial.println("inner loop breaked.");
      break;
    }
    if(key!=NO_KEY && count<2){ // incomlete
     Serial.println(key); 
     count++;
     myDFPlayer.play(88);
     delay(1500); 
    }
    if(count==2 && key!=NO_KEY){ //incomplete
